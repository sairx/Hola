...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Para Ari la niña más hermosa:\n\n Lo que siento por ti no cabe en palabras comunes ni en gestos pequeños, es una certeza profunda que permanece incluso cuando todo cambia alrededor, una fuerza que atraviesa miedos, distancias, silencios y días difíciles, y aun así, elige quedarse. \n\n Es algo que no depende del tiempo, ni del ánimo, ni de las circunstancias, porque nace desde un lugar tan honesto que no sabe hacer otra cosa que sostener. Es esa calma que aparece cuando pienso en ti, esa seguridad inexplicable de saber que, pase lo que pase, mi corazón ya encontró un sitio donde pertenecer\n\nY aunque el mundo dé mil vueltas, aunque cambien los caminos y las estaciones, esto que siento seguirá intacto, firme, y fiel es un sentimiento tan grande, tan leal y tan verdadero que no entiende de límites, porque simplemente aprendió a existir contigo. 🤍 `;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con cariño, Sair";
